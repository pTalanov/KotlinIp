var classes = function(){
  ...
  var tmp$1 = Kotlin.Class.create({initialize:function(formId, size){
    this.$formId = formId;
    this.$size = size;
    {
      var tmp$0;
  ...
  var tmp$2 = Kotlin.Trait.create({get_name:function(){
    return this.$name;
  }
  , apply:function(){
    {
  ...
  var tmp$4 = Kotlin.Class.create(tmp$2, {initialize:function(name_0, process){
    this.$name = name_0;
  ...
  var tmp$5 = Kotlin.Class.create(tmp$2, {initialize:function(w, h, r, g, b){
    this.$w = w;
    this.$h = h;
    this.$r = r;
    this.$g = g;
  ...
  var tmp$6 = Kotlin.Class.create(tmp$2, {initialize:function(name_0, size, intMatrix, divider){
    this.$name = name_0;
    this.$size = size;
  ...
  var tmp$7 = Kotlin.Class.create(tmp$2, {initialize:function(probability, d){
  ...
  var tmp$8 = Kotlin.Class.create(tmp$2, {initialize:function(probability, min){
    this.$probability = probability;
    this.$min = min;
  ...
  var tmp$9 = Kotlin.Class.create(tmp$2, {initialize:function(radius){
    this.$radius = radius;
  ...
  var tmp$10 = Kotlin.Class.create(tmp$2, {initialize:function(data){
    this.$data = data;
  ...
  var tmp$11 = Kotlin.Trait.create({render:function(builder, indent){
  }
  , toString:function(){
    {
  ...
  var tmp$12 = Kotlin.Class.create(tmp$11, {initialize:function(name_0){
    this.$name = name_0;
  ...
  var tmp$13 = Kotlin.Class.create(tmp$12, {initialize:function(name_0){
  ...
  var tmp$14 = Kotlin.Class.create(tmp$13, {initialize:function(name_0){
    this.super_init(name_0);
  }
  ...
  var tmp$15 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('button');
  }
  });
  var tmp$16 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('a');
  }
  , get_href:function(){
    {
  ...
  var tmp$17 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('h1');
  }
  });
  var tmp$18 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('p');
  }
  });
  var tmp$19 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('li');
  }
  });
  var tmp$20 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('b');
  }
  });
  var tmp$21 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('img');
  }
  , get_src:function(){
    {
  ...
  var tmp$22 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('ul');
  }
  , li:function(init){
    {
  ...
  var tmp$23 = Kotlin.Class.create(tmp$14, {initialize:function(){
    this.super_init('body');
  }
  });
  var tmp$24 = Kotlin.Class.create(tmp$13, {initialize:function(){
    this.super_init('title');
  }
  });
  var tmp$25 = Kotlin.Class.create(tmp$13, {initialize:function(){
  ...
  var tmp$26 = Kotlin.Class.create(tmp$13, {initialize:function(){
  ...
  var tmp$27 = Kotlin.Class.create(tmp$11, {initialize:function(text){
    this.$text = text;
  }
  , get_text:function(){
    return this.$text;
  ...
  return {B:tmp$20, Title:tmp$24, Body:tmp$23, UL:tmp$22, IMG:tmp$21, TextElement:tmp$27, Median:tmp$9, Head:tmp$25, HTML:tmp$26, Grid:tmp$5, LinearFilter:tmp$6, WhiteNoise:tmp$7, Dust:tmp$8, Form_0:tmp$1, Filter:tmp$2, PredefinedFilter:tmp$3, StandardFilter:tmp$4, HistoryEntry:tmp$0, Element_0:tmp$11, Difference:tmp$10, TagWithText:tmp$13, Tag:tmp$12, BodyTag:tmp$14, Button:tmp$15, A:tmp$16, H1:tmp$17, P:tmp$18, LI:tmp$19};
}
();
...
}, {Form_0:classes.Form_0, helper:Kotlin.Namespace.create({initialize:function(){
}
...
}, {}), filters:Kotlin.Namespace.create({initialize:function(){
...
}, {Difference:classes.Difference, Median:classes.Median, Dust:classes.Dust, WhiteNoise:classes.WhiteNoise, LinearFilter:classes.LinearFilter, Grid:classes.Grid, Filter:classes.Filter, StandardFilter:classes.StandardFilter, PredefinedFilter:classes.PredefinedFilter})});
ip.ui.initialize();
html.initialize();
ip.utils.initialize();
